...
use kouosl\dersprogrami\models\LoginForm;
use kouosl\dersprogrami\models\PasswordResetRequestForm;
use kouosl\dersprogrami\models\ResetPasswordForm;
use kouosl\dersprogrami\models\SignupForm;
use kouosl\dersprogrami\models\ContactForm;
use kouosl\dersprogrami\models\Setting;
    ...
    public function actionLogin()
    {
        ...
        if ($request->isPost) {
            ...
            if($response == null){
                ...
                //   return $this->goBack();
      return $this->redirect(['ders/index']);
                } else {
